...
class Tweet extends Component {
    ...
    render() {
        ...
        const {usuario, conteudo} = this.props
            ...
            <article className="tweet">
                ...
                <footer className="tweet__footer">
                    ...
                    <button className="btn btn--clean">
                        <svg
                        onClick={()=> this.setState(this.state.count === 0 ? {count: 1}: {count:0})}
                        className={`${this.state.count !== 0 ? "icon icon--small iconHeart--active" : "icon icon--small iconHeart"}`}
